...
/** Con clave de servicio no se puede cachear en estático. Ver la 199 */
...
export default async function PublicPPCReportPage({
  ...
  // Igual que el desglose de comisiones: página de servidor, enlace público, pero
  // leído con la clave de servicio. Ver el comentario largo de
  // app/report/commissions/[slug]/page.tsx y la migración 199.
