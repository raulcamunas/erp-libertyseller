...
export interface PanelEjecucionesProps {
  ...
  precios?: LotePrecio[]
  /**
   * Los listados que Amazon no deja tocar (migración 169).
   *
   * YA NO SE PINTAN. Era un panel ámbar fijo con seis SKU que solo se arreglan
   * en Seller Central: dice siempre lo mismo, no se puede accionar desde aquí y
   * acababa tapando lo que sí cambia en cada pasada.
   *
   * La marca sigue en la base y sigue haciendo su trabajo —esos SKU no entran
   * en los envíos, así que no queman llamadas— y se borra sola en cuanto Amazon
   * acepta un cambio suyo. La prop se queda porque la pasan dos pantallas.
   */
