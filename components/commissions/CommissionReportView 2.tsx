      ...
      <Card id="detalle-productos-csv">
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button
            ...
            onClick={() => {
              /**
               * SE GENERA SIEMPRE, YA NO SE DEVUELVE EL CSV SUBIDO.
               *
               * Antes, si el informe tenía guardado el fichero original, este
               * botón entregaba ESE: el CSV fiscal de Amazon tal cual, con la
               * ciudad, el código postal y el país de entrega de cada pedido y
