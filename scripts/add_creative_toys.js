// Script temporal para añadir Creative Toys a la base de datos
...
async function addCreativeToys() {
  console.log('🔄 Añadiendo cliente Creative Toys...')
  ...
  console.log('✅ Cliente Creative Toys añadido correctamente:')
